...
# Garante que os arquivos visuais (CSS/JS) funcionem no deploy
...
# 1. Adicione nos Apps Instalados
INSTALLED_APPS = [
...
# 2. Adicione no topo dos Middlewares
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # <-- Tem que ser o primeiro!
    'django.middleware.security.SecurityMiddleware',
    # ... os outros middlewares abaixo
]

# 3. Libere a porta padrão do Vite (http://localhost:5173)
